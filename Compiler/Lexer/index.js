...
STATICTOP = STATIC_BASE + 28640;
/* global initializers */  __ATINIT__.push({ func: function() { __GLOBAL__I_000101() } }, { func: function() { __GLOBAL__sub_I_test_cpp() } }, { func: function() { __GLOBAL__sub_I_iostream_cpp() } });
...
Module['wasmTableSize'] = 573;

Module['wasmMaxTableSize'] = 573;
...
var real__callMePlease = asm["_callMePlease"]; asm["_callMePlease"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__callMePlease.apply(null, arguments);
};
...
var _callMePlease = Module["_callMePlease"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_callMePlease"].apply(null, arguments) };
